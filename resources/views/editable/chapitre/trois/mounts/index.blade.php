...
<section class="background-black p-b-60">
        <div class="container">
            <div class="row" display="inline-block">
                ...
                <div class="card-body">
                <a href="{{ route('trois.mounts.create') }}"><h3>Ajouter</h3></a>
                    <div class="row justify-content-center">
                        <table class="table table-bordered" >
                            ...
                            @foreach($mounts->chunk(8) as $montures)
                                <div class="row justify-content-center">
                                    <tbody>
                                        ...
                                        @foreach($montures as $monture)
                                            <tr>
                                                ...
                                                <td scope="row" style="text-align: center;" height="10px">
                                                    <a href="{{ route('trois.mounts.edit', $monture->id) }}">{{ $monture->MountName }}</a>
                                                </td>
                                                <td scope="row" style="text-align: center;" height="10px">
                                                    <p>{{ $monture->MountVersion }}</p>
                                                </td>                                               
                                                <td scope="row" style="text-align: center;" height="10px">
                                                    <p>{{ $monture->MountPv }}</p>
                                                </td>
                                                <td scope="row" style="text-align: center;" height="10px">
                                                    <p>{{ $monture->MountShield }}</p>
                                                </td>
                                                <td scope="row" style="text-align: center;" height="10px">
                                                    <p>{{ $monture->MountPhysic }}</p>
                                                </td>
                                                <td scope="row" style="text-align: center;" height="10px">
                                                    <p>{{ $monture->MountMental }}</p>
                                                </td>
                                                <td scope="row" style="text-align: center;" height="10px">
                                                    <p>{{ $monture->MountReact }}</p>
                                                </td>
                                                <td scope="row" style="text-align: center;" height="10px">
                                                    <p>{{ $monture->MountMovement }}</p>
                                                </td>
                                                <td scope="row" style="text-align: center;" height="10px">
                                                    <p>{{ $monture->MountCost }}</p>
                                                </td>                                                
                                            </tr>                                                 
                                        @endforeach                                            
