                            ...
                            <div class="container border rounded p-4">
                                ...
                                <div class="form-floating">
                                    <label for="size">{{ __('Taille') }}</label>
                                        ...
                                        <option selected>{{ old('size') ?? $ville->size }}</option>
                                    ...
                                    <label for="nextCity2">{{ __('Villes voisines 2') }}</label>
                                        <div>
                                            <select class="form-select" id="nextCity2" aria-label="Floating label select example" name="nextCity2">
                                                <option selected>{{ old('nextCity2') ?? $ville->nextCity2 }}</option>
                                                @foreach(App\Models\City:: get() as $ville)
                                                <option value="{{ $ville->id }}">{{ $ville->name }}</option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="container border rounded p-4">
                                <div class="form-floating">
                                    <label for="story">{{ __('Histoire') }}</label>
                                            <textarea class="form-control" placeholder="Écrivez l'histoire ici" id="story" style="height: 100px" name="story">{{ old('story') ?? $ville->story }}</textarea>
                                </div>
